    ...
    showSwal: function(type){
        ...
        if(type == 'basic'){
        	...
        	swal({
                ...
                // confirmButtonClass: "btn btn-success btn-sm btn-round",
                type: "info"
            });

    	}else if(type == 'error-message'){
        	swal({
                title: "Please enter a value in all fields.",
                text: "",
                buttonsStyling: false,
                timer: 2000,
                showConfirmButton: false,
            ...
            swal({
                    ...
                    confirmButtonClass: 'btn btn-success btn-sm btn-round',
                    cancelButtonClass: 'btn btn-danger btn-sm btn-round cancel-deletion',
